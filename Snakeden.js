...
var _user$project$Snakeden$movePlayer = _elm_lang$core$Native_Platform.outgoingPort(
	'movePlayer',
	function (v) {
		return v;
	});
...
var _user$project$Snakeden$testPlayerInput = _elm_lang$core$Native_Platform.incomingPort('testPlayerInput', _elm_lang$core$Json_Decode$value);
...
var _user$project$Snakeden$Left = {ctor: 'Left'};
var _user$project$Snakeden$Down = {ctor: 'Down'};
var _user$project$Snakeden$Up = {ctor: 'Up'};
var _user$project$Snakeden$moveDecoder = function () {
	var convert = function (str) {
		var _p2 = _elm_lang$core$String$toLower(str);
		switch (_p2) {
			case 'up':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Snakeden$Up);
			case 'down':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Snakeden$Down);
			case 'left':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Snakeden$Left);
			case 'right':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Snakeden$Right);
			case 'jump':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Snakeden$Jump);
			default:
				return _elm_lang$core$Json_Decode$fail('I don\'t know that move');
		}
	};
	return A2(_elm_lang$core$Json_Decode$andThen, convert, _elm_lang$core$Json_Decode$string);
}();
var _user$project$Snakeden$inputDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'move',
	_user$project$Snakeden$moveDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'player',
...
var _user$project$Snakeden$main = _elm_lang$core$Platform$program(
	{init: _user$project$Snakeden$init, update: _user$project$Snakeden$update, subscriptions: _user$project$Snakeden$subscriptions})();

var Elm = {};
Elm['Snakeden'] = Elm['Snakeden'] || {};
if (typeof _user$project$Snakeden$main !== 'undefined') {
    _user$project$Snakeden$main(Elm['Snakeden'], 'Snakeden', undefined);
}
